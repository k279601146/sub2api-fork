export default {
  ...
  admin: {
    ...
    riskControl: {
      title: '风控中心',
      description: '配置传统内容审计策略并查看全部审核记录',
      loadFailed: '加载风控中心失败',
      ...
      openSettings: '传统内容审计设置',
      settingsTitle: '传统内容审计设置',
      gatewaySettingsNoticeTitle: '中国地区 Safety Gateway 配置已统一放在设置页',
      gatewaySettingsNoticeDesc: '风控中心只保留传统 OpenAI Moderations 内容审计、运行状态和审核记录。中国地区 Gateway 开关、抖音配置、分类器配置、封禁阈值和统计窗口请在设置页的“内容安全”中修改。',
      openContentSafetySettings: '打开内容安全设置',
      refreshStatus: '刷新状态',
      records: '审核记录',
    ...
    ide: {
      installations: {
        title: 'IDE 安装设备',
        description: '查看客户端安装量、活跃设备、版本平台分布和最近错误状态',
        total: '总安装数',
        activeDevices: '活跃设备',
        recentlyActive: '近 30 天活跃',
        withErrors: '有错误设备',
      ...
      problems: {
        title: 'IDE 问题记录',
        description: '按错误指纹聚合查看客户端启动、引擎、更新和完整性问题',
        totalProblems: '问题类型',
        totalOccurrences: '发生次数',
        ...
        problem: '问题',
        impact: '影响',
        versionPlatform: '版本 / 平台',
        lastSeen: '最近发生',
        devices: '设备',
        occurrences: '次',
        samples: '样本',
        recentSamples: '最近事件样本'
      },
      sessions: {
        title: 'IDE 客户端会话',
    ...
    settings: {
      ...
      defaults: {
        ...
        usageWindowLimitUnits: '5 小时用量上限',
        usageWindowLimitUnitsHint: '所有用户共享的 5 小时窗口 units 上限，保存后 dev2 和 T3Code 会按新值展示与拦截',
        usageWeeklyLimitUnits: '每周用量上限',
        usageWeeklyLimitUnitsHint: '所有用户共享的每周 units 上限，超过后需等待周窗口重置',
