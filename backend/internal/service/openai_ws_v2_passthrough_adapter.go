...
func (s *OpenAIGatewayService) proxyResponsesWebSocketV2Passthrough(
	...
	if blocked != nil {
		s.recordOpenAIFastPolicyBlock(ctx, c, account, capturedSessionModel, firstClientMessage, blocked)
	...
	policyClientConn := &openAIWSPolicyEnforcingFrameConn{
		...
		onBlock: func(blocked *OpenAIFastBlockedError) {
			s.recordOpenAIFastPolicyBlock(ctx, c, account, capturedSessionModel, nil, blocked)
