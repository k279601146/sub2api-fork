...
func TestGetTrustedClientIPUsesCloudflareHeaderBehindTrustedProxy(t *testing.T) {
	gin.SetMode(gin.TestMode)

	r := gin.New()
	require.NoError(t, r.SetTrustedProxies([]string{"127.0.0.1/8"}))
...
func TestGetTrustedClientIPIgnoresCloudflareHeaderFromPublicPeer(t *testing.T) {
	gin.SetMode(gin.TestMode)
